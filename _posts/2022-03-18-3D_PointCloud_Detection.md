...
<div style="text-align: center"><img src="{{ "/images/blog/3DPointcloudDetection/evaluate_res.png" | absolute_url }}" alt="" width = "600"/></div>

<div style="text-align: center"><img src="{{ "/images/blog/3DPointcloudDetection/result.gif" | absolute_url }}" alt="" width = "600"/></div>
check this github link if you have any more questions!
https://github.com/shirleyzzr1/DL_pointcloud.git